...
require_once __DIR__ . '/../vendor/autoload.php'; // Ruta a mPDF
...
if ($result > 0) {
    ...
    // Usamos una bandera para decir que es boleta
    $es_boleta = true;
    ...
    // Marca de agua si la boleta está anulada
    ...
    $mpdf->WriteHTML($html);
    $mpdf->Output('boleta_' . $noFactura . '.pdf', 'I');
    exit;
} else {
    echo "Boleta no encontrada o inválida.";
    exit;
}
